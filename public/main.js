...
const c = ['fa fa-close text-danger', 'fas fa-hamburger', 'fa fa-bus', 'fas fa-dice', 'fa fa-medkit', 'fas fa-tshirt', 'fa fa-shopping-cart', 'fa fa-bank', 'fa fa-tag']
const cc = ['Invalid option', 'Food', 'Transport', 'Entertainment', 'Medicine', 'Clothes', 'Groceries', 'Transaction', 'Uncategorized']
